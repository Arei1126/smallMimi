...
let stShop = new situation("商店街","人間の声が聞こえるぞ。そうだ、そこにいる人間に質問だ。この商店街のおすすめの店を教えてほしい。耳に向かって話しかけてくれ。さん、にい、いち、どうぞ。","うん","ありがとう、人間。またね。");
Situations.push(stShop);

let stKogaku = new situation("工学部付近","人間の声が聞こえるぞ。質問だ。お前は暇なとき何をしているんだ。耳に向かって話しかけてくれ。さん、にい、いち、どうぞ。","うん","ありがとう、人間。またね。");
