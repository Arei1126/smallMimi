...
let stLibrary = new situation("図書館","人間の声が聞こえるぞ。質問だ。お前は何をしに図書館に来たんだ？耳に向かって話しかけてくれ。さん、にい、いち、どうぞ。","うん、それで","ありがとう、人間。またね。");
Situations.push(stLibrary);
let stNamiko = new situation("浪高庭園","人間の声が聞こえるぞ。そうだ、質問だ。お前は、暇なとき何をしているんだ。耳に向かって話しかけてくれ。さん、にい、いち、どうぞ。","うん、それで","ありがとう、人間。またね。");
